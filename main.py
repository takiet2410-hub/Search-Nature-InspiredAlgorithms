...
def run_animated_3d_visualization(problem_name="Rastrigin"):
    """Generate a rotating 3D surface GIF for the given benchmark function."""
    func_map = {
        "Rastrigin":  (problems.rastrigin_function,  [[-5.12, 5.12], [-5.12, 5.12]]),
        "Ackley":     (problems.ackley_function,     [[-5, 5], [-5, 5]]),
        "Sphere":     (problems.sphere_function,     [[-5.12, 5.12], [-5.12, 5.12]]),
    ...
    folder_path = f"continuous/{problem_name.lower()}"
    visualization.plot_3d_landscape_animated(
        func, bounds_2d,
        f"3D Landscape — {problem_name}",
        f"{folder_path}/3d_landscape_animated",
        resolution=50, fps=30
    )
...
if __name__ == "__main__":
    ...
    # ================================================================
    # PART 4: ANIMATED 3D LANDSCAPE GIFs
    # ================================================================
    print("\n" + "="*60)
    print("GENERATING ANIMATED 3D LANDSCAPES")
    print("="*60)

    for prob in all_cont_problems:
        run_animated_3d_visualization(problem_name=prob)
